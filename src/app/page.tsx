            ...
            <div className="w-full lg:w-1/2">
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-lg text-gray-200">고객 중심</span>
                </div>
              </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-gray-900 to-transparent">
                  <div className="flex items-center gap-4">
                    <div className="flex flex-col">
                      <span className="text-xl font-bold text-white">렌탈 비즈니스의 전문가</span>
                      <span className="text-purple-300">10년 이상의 경험</span>
                    </div>
                  </div>
                </div>
              </div>
              
              <div className="absolute -bottom-6 -right-6 bg-purple-600 rounded-lg p-4 shadow-xl hidden md:block">
                <div className="text-center">
                  <span className="block text-4xl font-bold text-white">200+</span>
                  <span className="block text-sm text-white/80">성공 사례</span>
                </div>
              </div>
            </div>
          </div>
